...
<body>
                ...
                <div class="collapse navbar-collapse" id="toggle">
                    <div class="navbar-menu ml-auto">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="missing_person.php">Add/Update Person Data</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container text-center col-lg-7 col-xl-7">
        ...
        <h1 class="display-4">Person Data</h1>
            ...
            <?php
                ...
                function show($result){
                    ...
                    while($row = $result->fetch_assoc()){
                        echo "<tr><td><img src='".$row['image']."' class='img-thumbnail'></td><td>".$row['name']."</td><td>".$row['gender']."</td><td>".$row['last_seen']."</td><td>".$row['height']."</td><td><a class='btn btn-primary' href='person_data.php?name=".$row['name']."'>Delete</a></td></tr>";
                    }
                    echo "</table>";
                }
                if(isset($_GET["name"])){
                ...
                function delete($user){
                    global $conn;
                    $sql = "DELETE FROM person_data WHERE name='$user'";
                    $conn->query($sql);
                    echo "<script type='text/javascript'>document.location = 'person_data.php';</script>";
                }
            ?>
    </div>
