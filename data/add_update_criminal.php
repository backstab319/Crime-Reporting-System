...
<head lang="en">
    <meta charset="utf-8">
    <title>Add/Update Criminal Information</title>
...
<body>
    ...
    <div class="center-two-content container d-flex justify-content-center align-items-center">
        <div class="data text-center">
            ...
            <a href="addc_data.php" class="btn btn-outline-primary">Add Criminal Data</a>
        </div>
    </div>

    <div class="center-two-content container d-flex justify-content-center align-items-center">
        <div class="data text-center">
            <h1 class="display-4">Update Criminal Data</h1>
            <a href="updatec_data.php" class="btn btn-outline-primary">Update Criminal Data</a>
        </div>
    </div>
