...
<body>
    ...
    <div class="news d-flex flex-column">
        <div class="d-flex container justify-content-center align-items-start">
            <form action="managenews.php" method="POST">
            <div class="form-group text-center">
            <h1 class="display-4 text-light">Add News</h1>
                <input type="text" class="form-control mb-2" name="heading" placeholder="News Heading">
                <input type="text" class="form-control mb-2" name="body" placeholder="News Body">
            ...
            function add_news(){
                ...
                $head = $_POST["heading"];
                $body = $_POST["body"];
                $sql = "INSERT INTO news VALUES('$head','$body')";
        ...
        <div class="d-flex container justify-content-center align-items-end">
            <form action="managenews.php" method="POST">
                <div class="form-group text-center">
                    <h1 class="display-4 text-light">Update News</h1>
                    ...
                    <select name="column" id="news" class="form-control mb-2">
                        <option value="heading">News Heading</option>
                        <option value="body">News Body</option>
                    </select>
            ...
            <?php
                ...
                function update(){
                    ...
                    if(($oldval and $column and $newval)!= NULL){
                        $sql = "UPDATE news SET $column='$newval' WHERE $column='$oldval'";
