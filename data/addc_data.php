...
<body>
                ...
                <div class="collapse navbar-collapse" id="toggle">
                    <div class="navbar-menu ml-auto">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="criminal_data.php">View Criminal</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="text-center center-content container d-flex justify-content-center align-items-center">
        <div class="form-group col-lg-5 col-xl-5">
            <h1 class="display-4">Add Criminal Data</h1>
            <form action="addc_data.php" method="POST">
                ...
                <input type="text" class="form-control mb-2" name="charges" placeholder="Charges">
            ...
            <?php
                ...
                function add(){
                    ...
                    if(($img and $name and $gender and $last and $height and $charges)!= NULL){
                        check($img,$name,$gender,$last,$height,$charges);
                    }else{
                        echo "<p class='lead text-danger'>Please dont leave any fields empty!</p>";
                    }
                }
                function check($img,$name,$gender,$last,$height,$charges){
                    global $conn;
                    $sql = "SELECT * FROM criminal_data WHERE name='$name'";
                    $result = $conn->query($sql);
                    if($result->num_rows > 0){
                        echo "<p class='lead text-danger'>Criminal Data already exists</p>";
                    }else{
                        $sql = "INSERT INTO criminal_data VALUES('$img','$name','$gender','$last','$height','$charges')";
                        echo "<p class='lead text-danger'>Criminal Data Added</p>";
                        $conn->query($sql);
                    }
                }
            ?>
