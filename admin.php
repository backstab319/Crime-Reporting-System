...
<body>
                ...
                <div class="collapse navbar-collapse" id="toggle">
                    <div class="navbar-menu ml-auto">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/data/news.php">News</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="admin d-flex flex-column">
        <div class="d-flex align-items-start justify-content-center">
            ...
            <a href="/manage/manage_users.php" class="btn btn-primary">Manage Users</a>
            </div>
        </div>
        <div class="d-flex align-items-start justify-content-center mt-auto">
            <div class="data container text-center">
            <h1 class="display-4">Manage Stations</h1>
            <a href="/manage/manage_stations.php" class="btn btn-primary">Manage Stations</a>
            </div>
        </div>
        <div class="d-flex align-items-end justify-content-center mt-auto">
            <div class="data container text-center">
            <h1 class="display-4">Saftey Tips</h1>
            <a href="/manage/tips.php" class="btn btn-primary">Saftey Tips</a>
            </div>
        </div>
    </div>
